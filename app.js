...
// ===== HELPER: LOAD / SAVE USERS (VERSI AMAN) =====
...
async function handleTopup(userId, amount, adminCtx) {
  ...
  console.log(`✅ Saldo user ${userId} setelah top-up: Rp${users[userId].saldo.toLocaleString()}`);
...
// ===== KEYBOARD NOMOR KHUSUS TOP-UP USER =====
