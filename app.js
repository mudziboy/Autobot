  ...
  try {
    ...
    try {
      ...
      await ctx.editMessageMedia({
        type: 'photo',
        media: qrisImageUrl,
        caption: '💰 *Silakan scan QRIS berikut untuk melakukan top-up saldo Anda.*\n\n📌 Setelah membayar, kirim bukti transfer untuk verifikasi dengan menyertakan nama ID telegram | Admin : @rahmarie',
        parse_mode: 'Markdown'
      });
    } catch (imageError) {
    ...
    await ctx.editMessageText(
      '❌ *GAGAL! Terjadi kesalahan saat memproses permintaan Anda. Silakan hubungi Admin | @rahmarie*',
      { parse_mode: 'Markdown' }
    );
  }
});
