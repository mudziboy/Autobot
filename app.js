...
let PORT = parseInt(vars.PORT) || 50123; // pastikan number
const PORTS = [PORT, PORT + 1, PORT + 2]; // array port fallback
let currentPortIndex = 0;

function savePortToVars(port) {
  try {
    vars.PORT = Number(port); // pastikan tersimpan number
