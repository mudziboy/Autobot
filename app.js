...
app.post('/callback.php', async (req, res) => {
    ...
    logger.info(`[CALLBACK] VIOLETMEDIA Callback diterima dari IP: ${remoteIp}. Ref: ${data.ref}, API Status: ${data.status}`);
    ...
    try {
        // ✅ FIX: Cek status deposit di DB lokal tanpa kondisi "pending_auto"
