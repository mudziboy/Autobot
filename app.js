...
// ===== UTILITY VIOLETMEDIA: GET CHANNEL LIST (PINDAHKAN DARI BAWAH) =====
// Lokasi: Letakkan di sekitar Baris 2400-an, di luar bot.on('callback_query', ...)
async function getVioletPaymentChannels() {
    try {
        ...
        logger.error('❌ VIOLET API Fetch Channels Failed:', error.message);
