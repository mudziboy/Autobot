...
bot.action(/select_channel_(\w+)/, async (ctx) => {
    ...
    try {
        ...
        if (response.status === true || response.status === 'success') {
            ...
            // 🛠️ FIX MARKDOWN V2: Pastikan data numerik dan waktu ter-escape
            const totalBayarEscaped = escapeMarkdownV2(Number(totalBayarRaw).toLocaleString('id-ID'));
            const expiredAtEscaped = escapeMarkdownV2(new Date(expiredAtRaw).toLocaleString('id-ID'));
            ...
            // Template Invoice untuk Caption (Fix Error Markdown '-')
            const invoiceText = `
🧾 *INVOICE TOP-UP OTOMATIS*
━━━━━━━━━━━━━━━━\\━━━━━━━
🌐 *Metode:* ${escapeMarkdownV2(data.code_payment)}
💵 *Total Bayar:* Rp ${totalBayarEscaped} 
🕒 *Batas Bayar:* ${expiredAtEscaped} 
...
`.trim();
            ...
            if (data.target) {
                ...
                try {
                    ...
                    // Menggunakan "\n\n" karena di dalam template sudah di-escape oleh escapeMarkdownV2
